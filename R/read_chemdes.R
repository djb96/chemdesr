...
#'
#' @param smiles A simplified molecular-input line-entry system ("SMILES") string.
...
read_chemdes = function(smiles, desc = "chemopy"){
  ...
  form = rvest::html_form(session)[[1]] %>%
    rvest::html_form_set("Smiles" = smiles)
